    ...
    <div class="block">
        <div class="block-content">
            <div class="col-md-8 offset-md-2">
                <form action="<?=base_url("expenses/addCategory")?>" method="post" enctype="multipart/form-data">
                    <div class="form-group row">
                        <div class="col-md-12">
                            <label><?=trans("title")?></label>
                            <input type="text" class="form-control" name="exc_title" value="<?php if (isset($form_error)){ echo set_value('exc_title'); } ?>">
