...
<?php $this->load->view("$viewFolder/page_includes/calendar"); ?>
...
?>
<script src="<?=base_url("assets")?>/js/plugins/flatpickr/l10n/<?=get_lang_short_code($code)?>.js"></script>
<script>
    $(document).ready(function () {
        $(".js-flatpickr").flatpickr({
            minDate: "today",
            locale: '<?=get_lang_short_code($code)?>'
        });
    });
</script>
</body>
