    ...
    <div class="block">
        <div class="block-content">
            <div class="col-md-8 offset-md-2">
                <form action="<?=base_url("languages/addItem")?>" method="post" enctype="multipart/form-data">
                    <div class="form-group row">
                        <div class="col-md-12">
                            <label><?=trans("language_name")?></label>
                            <input type="text" class="form-control" name="title" value="<?php if (isset($form_error)){ echo set_value('title'); } ?>">
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" name="code" value="<?php if (isset($form_error)){ echo set_value('code'); } ?>">
                            <?php if(isset($form_error)): ?>
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" name="folder_name" value="<?php if (isset($form_error)){ echo set_value('folder_name'); } ?>">
                            <?php if(isset($form_error)): ?>
