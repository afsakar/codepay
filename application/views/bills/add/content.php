<div class="content">
    ...
    <div class="block repeater">
        <form action="<?=base_url("bills/addItem")?>" method="post">
            <div class="block-header block-header-default">
                <h3 class="block-title"><input type="text" class="form-control-plaintext" name="bill_number" placeholder="<?=trans("please_entry_bill_number")?>" required></h3>
            ...
            <div class="block-content">
                ...
                <div class="row my-20">
                    ...
                    <div class="col-6 text-right">
                        <div id="supplier-box">
                            <select name="sup_id" id="sup_id" class="form-control js-select2" data-url="<?=base_url("bills/getSupplier")?>" data-placeholder="<?=trans("please_select_supplier")?>" required>
                                <option></option>
                                <?php foreach ($suppliers as $supplier): ?>
                                    <option value="<?=$supplier->sup_id?>" data-name="<?=$supplier->sup_name?>">
                                        <?=$supplier->sup_name?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div id="supplier_detail" class="d-none mt-50">
                        </div>
                    </div>
                    <!-- END Client Info -->
                </div>
                ...
                <div class="m-20 row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-11">
                                <input type="text" class="js-datepicker form-control-plaintext" id="example-datepicker1" value="<?php if (isset($form_error)){ echo set_value('op_date'); } ?>" placeholder="Select date" name="bill_cre_date" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="yyyy/mm/dd" required>
                            </div>
                        </div>
                    </div>
                ...
                <div class="table-responsive push">
                    <table class="table table-bordered table-hover" data-repeater-list="items">
                        ...
                        <tbody id="products" data-repeater-item>
                            <tr id="item">
                                <td class="text-center">
                                    <input type="text" class="form-control-plaintext text-center pr_code" id="pr_code" name="[pr_code]" value="" readonly>
                                </td>
                                <td>
                                    <select name="[pr_id]" id="pr_id" class="form-control-plaintext products" data-url="<?=base_url("bills/getProduct")?>" required>
                                        <option><?=trans("please_select_product")?></option>
                                        <?php foreach ($products as $product): ?>
                                            <option value="<?=$product->pr_id?>">
                                                <?=$product->pr_name?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                                ...
                                <td class="text-center">
                                    <input type="text" class="form-control-plaintext text-center pr_unit" id="pr_unit" name="[pr_unit]" value="" readonly>
                                </td>
                                <td class="text-center">
                                    <input type="text" class="form-control-plaintext text-center pr_qnt" id="pr_qnt" name="[pr_qnt]" value="">
                                </td>
                                <td class="text-center">
                                    <input type="text" class="form-control-plaintext text-center pr_amount" id="pr_amount" name="[pr_amount]" value="" readonly>
                                </td>
                                <td class="text-center item_tax">
                                </td>
                                <td class="text-center">
                                    <input type="text" class="form-control-plaintext text-center pr_price" id="pr_price" name="[pr_price]" value="" readonly>
                                </td>
                                <td class="d-none">
                                    <input type="text" class="form-control-plaintext text-center pr_tax" id="pr_tax" name="[pr_tax]" value="" readonly>
                                </td>
                        ...
                        <tfoot>
                        <tr>
                            <td colspan="7" class="font-w600 text-right">Matrah</td>
                ...
                <div class="form-group row">
                    <div class="col-md-12">
                        ...
                        <textarea name="bill_description" class="form-control-plaintext text-center" rows="5" placeholder="<?=trans("description")?>..." required></textarea>
                    </div>
                </div>
                </p>
                <!-- END Footer -->
