                    ...
                    <div class="block block-themed block-rounded block-shadow">
                        ...
                        <div class="block-content">
                            <div class="form-group row">
                                <div class="col-12">
                                    <img class="img-avatar img-avatar-thumb" src="<?=base_url("uploads/users/$userimg")?>" alt="">
                                </div>
                            </div>
                            <div class="form-group row" style="display: none;">
                                <div class="col-12">
                                    <label for="login-username"><?=trans("email")?></label>
                                    <input type="email" class="form-control" id="login-username" name="user_email" placeholder="<?=trans("enter_email")?>" value="<?php if (isset($form_error)){ echo set_value('user_email'); }elseif($remember_me){echo $member->email;}else{ echo $usermail; } ?>">
                            ...
                            <div class="form-group row">
                                <div class="col-12">
                                    ...
                                    <input type="password" class="form-control" id="login-password" name="user_password" placeholder="<?=trans("enter_password")?>" value="<?php if($remember_me) { echo $member->password; }else{ null; }?>">
