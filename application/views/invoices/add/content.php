<div class="content">
    ...
    <div class="block repeater">
        <form action="<?=base_url("invoices/addItem")?>" method="post">
            <div class="block-header block-header-default">
                <h3 class="block-title"><input type="text" class="form-control-plaintext" name="inv_number" placeholder="<?=trans("please_entry_invoice_number")?>" required></h3>
            ...
            <div class="block-content">
                ...
                <div class="row my-20">
                    ...
                    <div class="col-6 text-right">
                        <div id="customer-box">
                            <select name="cus_id" id="cus_id" class="form-control js-select2" data-url="<?=base_url("invoices/getCustomer")?>" data-placeholder="<?=trans("please_select_customer")?>" required>
                                <option></option>
                                <?php foreach ($customers as $customer): ?>
                                    <option value="<?=$customer->cus_id?>" data-name="<?=$customer->cus_name?>">
                                        <?=$customer->cus_name?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                ...
                <div class="m-20 row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-11">
                                <input type="text" class="js-datepicker form-control-plaintext" id="example-datepicker1" value="<?php if (isset($form_error)){ echo set_value('op_date'); } ?>" placeholder="Select date" name="inv_cre_date" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="yyyy/mm/dd" required>
                            </div>
                        </div>
                    </div>
                        ...
                        <tbody id="products" data-repeater-item>
                            <tr id="item">
                                <td class="text-center">
                                    <input type="text" class="form-control-plaintext text-center sr_code" id="sr_code" name="[sr_code]" value="" readonly>
                                </td>
                                <td>
                                    <select name="[sr_id]" id="sr_id" class="form-control-plaintext services" data-url="<?=base_url("invoices/getService")?>" required>
                                        <option><?=trans("please_select_service")?></option>
                                        <?php foreach ($services as $service): ?>
                                            <option value="<?=$service->sr_id?>">
                                                <?=$service->sr_name?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                                ...
                                <td class="text-center">
                                    <input type="text" class="form-control-plaintext text-center sr_unit" id="sr_unit" name="[sr_unit]" value="" readonly>
                                </td>
                                <td class="text-center">
                                    <input type="text" class="form-control-plaintext text-center sr_qnt" id="sr_qnt" name="[sr_qnt]" value="">
                                </td>
                                <td class="text-center">
                                    <input type="text" class="form-control-plaintext text-center sr_amount" id="sr_amount" name="[sr_amount]" value="" readonly>
                                </td>
                                <td class="text-center item_tax">
                                </td>
                                <td class="text-center">
                                    <input type="text" class="form-control-plaintext text-center sr_price" id="sr_price" name="[sr_price]" value="" readonly>
                                </td>
                                <td class="d-none">
                                    <input type="text" class="form-control-plaintext text-center sr_tax" id="sr_tax" name="[sr_tax]" value="" readonly>
                                </td>
                ...
                <div class="form-group row">
                    <div class="col-md-12">
                        ...
                        <textarea name="inv_description" class="form-control-plaintext text-center" rows="5" placeholder="<?=trans("description")?>..." required></textarea>
                    </div>
                </div>
                </p>
                <!-- END Footer -->
